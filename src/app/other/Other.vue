<template>
  <div
    id="PTTChat-contents-other-main"
    :class="Classes"
  >
    ...
    <p class="mt-1 mb-0 ml-5">
      4.鍵入大寫Q複製文章完整AID(例#1W0MaOkF (C_Chat))
    </p>
    <p class="mt-1 mb-0 ml-5">
      5.將複製的AID貼上並讀取文章
    </p>
    <h4 class="text-center mt-5 mb-1">
      相關連結
    </h4>
    <hr class="mt-1 mb-2">
